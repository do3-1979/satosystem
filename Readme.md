...
## 最新パフォーマンス (2025-12-29 更新)

**最適パラメータ確定版**:
- volatility_term = 28
- donchian_buy_term = 32, donchian_sell_term = 32
- entry_times = 3
- stop_range = 2
- stop_af_add = 0.01
- pvo_threshold = 5
...
**バックテスト成績** (2024/Q2 - 2025/Q4):
- **累積損益**: +374.95 USD
- **利益因子**: 1.22
- **成功四半期**: 7/7
- **平均四半期損益**: 53.56 USD
- **注**: 2024/Q1 (+2,076 USD) は異常相場のため分析対象外

**改善経緯**:
- 2025-12-21: PVO最適化、volatility/donchian パラメータスイープ完了
- 2025-12-29: 2024/Q1除外分析完了、最終パラメータ確定
  
詳細分析: [Q1除外分析レポート](./report/Q1_EXCLUSION_ANALYSIS_SUMMARY.md)
