...
# TODO 2023/7/23 長期間(6か月)で大トレンドだけ拾えるようなシグナルのフィルタが必要 > DONE
# どうやって？
# ＞各パラメタ調整の意味から考える
...
# pvo = 大きくするほど、出来高変化率をフィルタできる
# 
# パラメタの修正ステップ
# １．半年間で継続的に上昇できるように
# ２．撤退時のリスクを減らせるように　→　資産グラフの傾向が右肩上がりになるように。
# ３．他のパラメタで利益を調整
#　→　8/19 更新完了。
...
# なぜ大きいか？
# 
# pvoをあまり大きくしすぎるとエントリを失うが、だましは減らせている
# 2023/3までは今のパラメタでは利益があまりでない　
# → 出来高の傾向が違うから？
